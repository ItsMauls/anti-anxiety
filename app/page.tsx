...
export default function Home() {
  ...
  const messages = [
    ...
    "Dan juga sejujurnya, aku udah lama banget not being in relationship, jadi emang dingin, tapi sama kamu aku terus belajar.",
    "Maaf, energi aku juga cepet abisnya, kadang jam 10 udah tidur 😅",
    "Aku kadang butuh waktu buat memproses emosi, bukan berarti emang ninggalin.",
    "Dan yang terakhir...",
